...
export interface SessionUiCopy {
  ...
  skipTour: string
  showExplanationAgain: string
  repairInstruction: string
  level2TestInstruction: string
  running: string
  testing: string
